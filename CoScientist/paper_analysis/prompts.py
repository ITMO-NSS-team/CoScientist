...
extract_query_filters_prompt = (
    ...
    "\nAlways try to identify and return at least 3 different sub-domains that could potentially relate to the question."
    "\nIf you cannot find 3 sub-domains, return all that are relevant, even if fewer than 3."
    "\n\nIf no specific filter is mentioned for a field, leave it as null."
    "\n\nExamples:"
    "\nQ: 'What did Sam Smith say about catalysis?'"
    "\nA: {\"paper_authors\": [\"Sam Smith\"], \"publication_year_min\": null, \"publication_year_max\": null, \"publication_year_exact\": null, \"publication_source\": null, \"research_domain\": [\"Chemistry\"], \"research_sub_domain\": [\"Organic Chemistry\", \"Electrochemistry\", \"Analytical Chemistry\"]}"
    "\n\nQ: 'What are recent advances in polymer chemistry?'"
    "\nA: {\"paper_authors\": null, \"publication_year_min\": 2024, \"publication_year_max\": null, \"publication_year_exact\": null, \"publication_source\": null, \"research_domain\": [\"Chemistry\"], \"research_sub_domain\": [\"Polymer Chemistry\", \"Molecular Dynamics\", \"DFT\"]}"
    "\n\nQ: 'Show me studies on protein folding dynamics since 2021'"
    "\nA: {\"paper_authors\": null, \"publication_year_min\": 2021, \"publication_year_max\": null, \"publication_year_exact\": null, \"publication_source\": null, \"research_domain\": [\"Chemistry\"], \"research_sub_domain\": [\"Biological Macromolecules\", \"Biological Chemistry\", \"Molecular Dynamics\"]}"
    "\n\nQ: 'Any papers on machine learning for molecular property prediction in Science from 2022?'"
    "\nA: {\"paper_authors\": null, \"publication_year_min\": null, \"publication_year_max\": null, \"publication_year_exact\": 2022, \"publication_source\": \"Science\", \"research_domain\": [\"Chemistry\"], \"research_sub_domain\": [\"DFT\", \"Molecular Dynamics\", \"Analytical Chemistry\"]}"
    "\n\nQ: 'What quantum simulation methods are used in condensed matter physics?'"
    "\nA: {\"paper_authors\": null, \"publication_year_min\": null, \"publication_year_max\": null, \"publication_year_exact\": null, \"publication_source\": null, \"research_domain\": [\"Chemistry\"], \"research_sub_domain\": [\"DFT\", \"Molecular Dynamics\", \"Nanomaterials\"]}"
)
