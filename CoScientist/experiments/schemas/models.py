"""Strict Pydantic contracts for Experiment Module v0."""
...
class ExperimentTask(StrictModel):
    ...
    def coerce_task_shape(cls, data: Any) -> Any:
        ...
        for key in ("hypothesis_ref", "also_tests", "experiment_question", "dataset",
                    "baselines", "metrics", "analysis_artifacts"):
