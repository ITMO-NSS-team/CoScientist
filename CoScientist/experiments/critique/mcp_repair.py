...
def _stub_coder_task(task_id: str, op: dict[str, str], hypothesis_id: str) -> dict[str, Any]:
    ...
    return {
        ...
        "design": {
            ...
            "baselines": [{"name": "operation-specified method", "kind": "method", "ref": None}],
            "metrics": [{"name": "artifact_present", "direction": "maximize"}],
            "analysis_artifacts": [{
                "name": "analysis.py", "role": "code",
                "prepare_via": "coder", "path_or_tool": "analysis.py",
            }],
        },
        "mcp_servers": [],
        "input_data": [],
